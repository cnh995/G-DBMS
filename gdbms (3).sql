...
--
-- Host: 127.0.0.1
-- Generation Time: May 01, 2018 at 02:30 AM
...
DROP TABLE IF EXISTS `assistantships`;
...
(3, 5, '8883333', 'GTA', '2016-07-01', '2016-07-30', NULL, 2, 3, '10000.00', 1, '1/4 time'),
...
(9, 11, '8884444', 'GTA', '2018-04-01', '2018-04-30', '2018-04-25', 2, 4, '10000.00', 1, '1/2 Time'),
(10, 10, '8883333', 'GTA', '2018-04-01', '2018-04-30', '2018-04-28', 2, 3, '15000.00', 2, '1/4 Time'),
(11, 12, '8882222', 'GTA', '2018-04-02', '2018-04-30', '2018-04-20', 2, 2, '12000.00', 2, '1/3 Time'),
(12, 13, '8881111', 'GTA', '2018-04-01', '2018-04-30', '2018-04-19', 2, 5, '11000.00', 1, '1/2 Time');
...
DROP TABLE IF EXISTS `assistantship_statuses`;
...
DROP TABLE IF EXISTS `gce_results`;
...
DROP TABLE IF EXISTS `gqe_offerings`;
...
--
DROP TRIGGER IF EXISTS `after_gqe_offerings_update`;
DELIMITER $$
...
DROP TABLE IF EXISTS `gqe_results`;
...
--
DROP TRIGGER IF EXISTS `before_gqe_results_insert`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `before_gqe_results_update`;
DELIMITER $$
...
DROP TABLE IF EXISTS `gqe_sections`;
...
DROP TABLE IF EXISTS `gta_assignments`;
CREATE TABLE `gta_assignments` (
  ...
  `enrollment_percent` float DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `gta_assignments` (`id`, `assistantship_id`, `instructor_id`, `course`, `num_labs_or_grader`, `num_students`, `enrollment_percent`) VALUES
(1, 2, '0001111', 'CS455', '3', 25, 80),
(2, 3, '0002222', 'CS364', '4', 20, 75),
(3, 7, '0001111', 'CS463', 'Grader', 22, 86),
(7, 12, '0001111', 'CS161', '2', 23, 56);
...
DROP TABLE IF EXISTS `ielts_scores`;
...
DROP TABLE IF EXISTS `pass_levels`;
...
DROP TABLE IF EXISTS `toefl_scores`;
...
DROP TABLE IF EXISTS `tuition_waivers`;
...
('christian.hansen@ndus.edu', 'Christian', 'Hansen', '$2y$10$avh5jvFq2Quuk/6NAisfoOvUbEYk3NNE0ew1l7hNi.dPVNxC8Aht2', 1, '2018-04-12 05:31:20', 'C2yX4cMufnPQehxFMpHJiZZInHBNR3OnoAQooI17CayC6p2sfgxV4ni3Icuz', NULL, '2018-05-01 05:13:27'),
